(function (root, factory) {
  ...
  var EN = {
    ...
    'portfolio.kicker': '03 · STORE PORTFOLIO', 'portfolio.heading': 'Screen the portfolio through three business lenses',
    'portfolio.lensAria': 'Store portfolio analysis lens',
    'portfolio.performance': 'Performance', 'portfolio.efficiency': 'Efficiency',
    'portfolio.varianceContribution': 'Variance Contribution',
    'portfolio.searchStore': 'Search Store', 'portfolio.searchStorePlaceholder': 'Search store name',
    'portfolio.selectedStore': 'Selected Store',
    'portfolio.selectedStoreIneligible': 'Selected store is not eligible for the Performance view.',
    'portfolio.performanceTitle': 'CC% × Productivity Evolution',
    'portfolio.performanceSub': 'Current Customer Contribution % · productivity change vs comparison · bubble size shows Current Productivity',
    'portfolio.performanceChartAria': 'Store performance bubble map',
    'portfolio.efficiencyTitle': 'Productivity by DA HC',
    'portfolio.efficiencySub': 'Horizontal headcount lanes make similar store productivity directly comparable',
    'portfolio.screeningView': 'SCREENING VIEW', 'portfolio.efficiencyChartAria': 'Productivity by headcount horizontal lanes',
    'portfolio.screeningNotice': 'This is a screening signal, not a staffing recommendation.',
    'portfolio.businessState': 'Business State', 'portfolio.eligibleStores': 'Eligible stores',
    'portfolio.zeroThresholds': 'Reference lines: CC% = 0 · Productivity Evol = 0',
    'portfolio.bubbleLegend': 'Bubble size = Current Productivity', 'portfolio.excluded': 'Excluded',
    'portfolio.excludedCount': '{count} stores excluded',
    'portfolio.excludedNewStores': '{count} New Stores',
    'portfolio.excludedNoComparison': '{count} stores without comparable prior-year productivity',
    'portfolio.excludedMissingMetrics': '{count} stores with missing required metrics',
    'portfolio.noExclusions': 'All stores in scope are eligible',
    'portfolio.potentialReviewCount': 'Potential review observations',
    'portfolio.storeDots': 'Stores',
    'portfolio.potentialReview': 'Potential Review Opportunity',
    'portfolio.potentialReviewReason': 'Productivity falls within the typical range of {count}-DA stores.',
    'performanceState.healthy-growth': 'Healthy Growth',
    'performanceState.high-return-decline': 'High Return, Productivity Decline',
    'performanceState.growth-low-return': 'Growth, Low Return',
    'performanceState.priority-review': 'Priority Review',
    'portfolio.ranking': 'Store Variance Ranking',
    ...
    'portfolio.noDirection': 'No stores in this direction',
    ...
    'detail.structuralPlaceholder': 'Source unavailable · structural placeholder',
    ...
    'pnl.transactionalMediaSpecificLine': 'Transactional media specific', 'pnl.livestreamersLine': 'Livestreamers',
    'pnl.eShopInShopWebsitesLine': 'E-shop in shop websites', 'pnl.otherPromotionsLine': 'Other promotions',
    'pnl.animationsTowardDistributor': 'Animations toward the distributor',
    'pnl.animationsImmoPosAdv': 'Animations of immo POS adv',
    ...
    'pnl.otherPosAdvertising': 'Other POS advertising costs',
    'pnl.tester': 'Tester', 'pnl.daCost': 'DA Cost', 'pnl.specificDevelopment': 'Specific Development',
    'pnl.otherAP': 'Others', 'pnl.specificDevelopmentSubtotal': 'Specific development',
    'pnl.nonDaCost': 'Non DA Cost', 'pnl.specificAP': 'Specific A&P',
    'pnl.specificSga': 'Total Specific SG&A', 'pnl.totalSpecificCosts': 'Total Specific Costs',
    'pnl.daHeadcount': 'DA HC', 'pnl.daHeadcountPerPos': 'DA HC / POS',
    'pnl.daCostAndSpecificDevelopment': 'DA Cost & Specific Development',
    'pnl.customerContribution': 'CUSTOMER CONTRIBUTION', 'pnl.nonSpecificCosts': 'Non-specific Costs',
    'pnl.totalNonSpecificCosts': 'Total non-specific costs', 'pnl.operatingProfit': 'OPERATING PROFIT',
    ...
    'cap.performancePortfolio': 'Performance portfolio', 'cap.productivitySummary': 'Productivity Summary',
    'cap.headcountEfficiency': 'Headcount Efficiency analysis', 'cap.filteredCustomerContributionBridge': 'Customer Contribution Bridge',
    ...
    'error.noEligiblePerformanceStores': 'No eligible performance stores for this selection',
    'error.noComparisonProductivity': 'No comparable prior-year productivity is available.',
    'error.noDaHeadcountData': 'No DA HC data is available for this selection',
    'error.noEfficiencySample': 'Insufficient eligible stores for the efficiency view',
  ...
  var ZH = Object.assign({}, EN, {
    ...
    'portfolio.kicker': '03 · 门店组合分析', 'portfolio.heading': '从三个经营视角筛查门店组合',
    'portfolio.lensAria': '门店组合分析视角',
    'portfolio.performance': '经营表现', 'portfolio.efficiency': '人员效率',
    'portfolio.varianceContribution': '差异贡献',
    'portfolio.searchStore': '搜索门店', 'portfolio.searchStorePlaceholder': '输入门店名称搜索',
    'portfolio.selectedStore': '当前选中门店',
    'portfolio.selectedStoreIneligible': '当前选中门店不符合经营表现视图的纳入条件。',
    'portfolio.performanceTitle': '客户贡献率 × 门店单产变化率',
    'portfolio.performanceSub': '当前客户贡献率 · 门店总单产较对比期变化 · 气泡大小代表当前门店总单产',
    'portfolio.performanceChartAria': '门店经营表现气泡图',
    'portfolio.efficiencyTitle': '不同销售人员人数下的门店总单产',
    'portfolio.efficiencySub': '按销售人员人数横向排列门店，直观比较相近的门店总单产',
    'portfolio.screeningView': '筛查视角', 'portfolio.efficiencyChartAria': '按销售人员人数横向排列的门店总单产图',
    'portfolio.screeningNotice': '该标记仅用于筛查，不代表人员调整建议。',
    'portfolio.businessState': '经营状态', 'portfolio.eligibleStores': '可分析门店',
    'portfolio.zeroThresholds': '参考线：客户贡献率 = 0 · 门店单产变化率 = 0',
    'portfolio.bubbleLegend': '气泡大小 = 当前门店总单产', 'portfolio.excluded': '未纳入',
    'portfolio.excludedCount': '未纳入 {count} 家门店',
    'portfolio.excludedNewStores': '{count} 家新开门店',
    'portfolio.excludedNoComparison': '{count} 家门店缺少可比的上年同期单产',
    'portfolio.excludedMissingMetrics': '{count} 家门店缺少必要指标',
    'portfolio.noExclusions': '当前范围内所有门店均可纳入分析',
    'portfolio.potentialReviewCount': '可进一步复盘的观察点',
    'portfolio.storeDots': '门店',
    'portfolio.potentialReview': '可进一步复盘',
    'portfolio.potentialReviewReason': '该门店单产落在 {count} 人门店的典型区间内，可进一步复盘人员配置。',
    'performanceState.healthy-growth': '健康增长',
    'performanceState.high-return-decline': '高回报但单产下滑',
    'performanceState.growth-low-return': '增长但回报偏低',
    'performanceState.priority-review': '优先复盘',
    'portfolio.ranking': '门店差异排名',
    ...
    'detail.structuralPlaceholder': '源字段不可用 · 结构占位',
    ...
    'pnl.transactionalMediaSpecificLine': '专项交易媒体', 'pnl.livestreamersLine': '直播人员费用',
    'pnl.eShopInShopWebsitesLine': '店中店网站费用', 'pnl.otherPromotionsLine': '其他促销',
    'pnl.animationsTowardDistributor': '经销商活动费用',
    'pnl.animationsImmoPosAdv': '固定 POS 广告摊销及核销',
    ...
    'pnl.otherPosAdvertising': '其他 POS 广告费用',
    'pnl.merchandising': '陈列', 'pnl.animations': '活动', 'pnl.tester': '试用装',
    'pnl.daCost': '销售人员费用', 'pnl.specificDevelopment': '专项开发',
    'pnl.otherAP': '其他', 'pnl.specificDevelopmentSubtotal': '专项开发',
    'pnl.nonDaCost': '非销售人员费用', 'pnl.specificAP': '专项广告及促销',
    'pnl.specificSga': '专项销售及管理', 'pnl.totalSpecificCosts': '专项费用合计',
    'pnl.daHeadcount': '销售人员人数', 'pnl.daHeadcountPerPos': '销售人员人数 / POS',
    'pnl.daCostAndSpecificDevelopment': '销售人员费用与专项开发',
    'pnl.nonSpecificCosts': '非专项费用', 'pnl.totalNonSpecificCosts': '非专项费用合计',
    ...
    'cap.performancePortfolio': '经营表现门店组合', 'cap.productivitySummary': '门店总单产概览',
    'cap.headcountEfficiency': '人员效率分析', 'cap.filteredCustomerContributionBridge': '客户贡献桥接分析',
    ...
    'error.noEligiblePerformanceStores': '当前筛选范围内没有可纳入经营表现分析的门店',
    'error.noComparisonProductivity': '缺少可比的上年同期门店总单产。',
    'error.noDaHeadcountData': '当前筛选范围内没有销售人员人数数据',
    'error.noEfficiencySample': '当前范围内可用于人员效率分析的门店样本不足',
  ...
  function renderLanguageSwitch() {
    ...
    var rail = root.document.querySelector('.brand-rail');
    var railStatus = rail && rail.querySelector('.rail-status');
    if (!rail || !railStatus || root.document.getElementById('languageSwitch')) return;
    var utilityArea = root.document.createElement('div');
    utilityArea.className = 'rail-utility-area';
    ...
    rail.insertBefore(utilityArea, railStatus);
    utilityArea.appendChild(control);
    utilityArea.appendChild(railStatus);
