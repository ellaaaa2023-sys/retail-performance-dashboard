(function (root, factory) {
  ...
  var EN = {
    ...
    'common.variancePct': 'Variance %', 'common.netSalesPct': '% of Net Sales', 'common.all': 'All',
    ...
    'variance.bridgeDescription': 'Amount-based Bridge with ratio-based variance readout',
    ...
    'variance.driverDescription': 'Amounts and % of Net Sales · click a row to preserve Store Ranking context',
    ...
    'detail.storePnl': 'Store P&L', 'detail.storePnlSub': 'Signed P&L values in KRMB; ratios shown as % of Net Sales',
    'detail.signals': 'Store Signals', 'detail.signalsSub': 'Rule-based review prompts',
    'detail.apComposition': 'A&P Component Composition',
    'detail.apCompositionSub': 'Current vs Comparison · amount and share of the non-overlapping component pool',
    ...
    'metric.productivityEvolPct': 'Productivity Evol %', 'metric.daHeadcount': 'DA HC',
    ...
    'field.tester': 'Tester', 'field.daCostAndSpecificDevelopment': 'DA Cost & Specific Development', 'field.otherAP': 'Others',
  ...
  var ZH = Object.assign({}, EN, {
    ...
    'common.variancePct': '差异率', 'common.netSalesPct': '占净销售额比例', 'common.all': '全部',
    ...
    'variance.bridgeDescription': '按金额桥接，并展示比例差异',
    ...
    'variance.driverDescription': '金额及占净销售额比例 · 点击科目保留门店排名上下文',
    ...
    'detail.storePnl': '单店损益表', 'detail.storePnlSub': '损益表金额单位为 KRMB；比例按净销售额计算',
    'detail.signals': '门店提示', 'detail.signalsSub': '基于规则的复盘提示',
    'detail.apComposition': '广告及促销构成',
    'detail.apCompositionSub': '当前期对比对比期 · 非重叠组成池的金额及占比',
    ...
    'field.tester': '试用装', 'field.daCostAndSpecificDevelopment': '销售人员费用与专项开发', 'field.otherAP': '其他',
